...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TimerWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 34, 11)
    ...
    "TimerWidget\0startTimer\0\0stopTimer\0"
    "updateLabel\0"
};
...
void TimerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TimerWidget *_t = static_cast<TimerWidget *>(_o);
        switch (_id) {
...
const QMetaObject TimerWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TimerWidget.data,
